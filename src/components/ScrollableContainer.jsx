...
class ScrollableContainer extends React.Component {
  ...
  componentDidMount() {
    ...
    this.mObserver.observe(this.scrollableContainer,
    ...
    addResizeListener(this.container,
  ...
  componentWillUnmount() {
    ...
    removeResizeListener(this.container,
      this.resizeHandler);
  }
 ...
 */
  handleScrollRight() {
    ...
    if (Math.abs(scrollableContainerTransform) < this.scrollableContainerWidth) {
      const offset = Math.max(scrollableContainerTransform - Number(distance),
        -this.scrollableContainerWidth + this.containerWidth);
      this.setState({
        "showPrev": true,
  ...
  */
  handleScrollLeft() {
    ...
    if (scrollableContainerTransform < 0) {
      const offset = Math.min(scrollableContainerTransform + Number(distance), 0);
      this.setState({
        "showPrev": offset !== 0,
        "showNext": true,
        "scrollableContainerTransform": offset
  ...
  render() {
    ...
    return (
      <div className="r-scrollable-container">
        <div className="r-scrollable-btn r-scrollable-btn--left"
        ...
        <div className="r-scrollable-btn r-scrollable-btn--right"
        ...
        <div
          className="r-scrollable-content"
          ref={container => this.container = container}
          style={{ overflow: 'hidden' }}>
          <div ref={scrollableContainer => this.scrollableContainer = scrollableContainer}
...
ScrollableContainer.propTypes = {
  "distance": PropTypes.oneOfType([PropTypes.number,
  PropTypes.string]),
